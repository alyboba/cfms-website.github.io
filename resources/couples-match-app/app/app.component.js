...
var match_service_promise_1 = require('./match.service.promise');
...
var AppComponent = (function () {
    function AppComponent(matchService) {
    ...
    AppComponent.prototype.reOrderItemsA = function (item) {
        alert('ss');
        console.log("reOrderItems called:");
        console.log(item);
    };
    AppComponent.prototype.reOrderItemsB = function (item) {
        console.log("reOrderItems called:");
        console.log(item);
    };
    ...
    AppComponent.prototype.getItemsA = function () {
        var _this = this;
        this.matchService.getItemsA()
            .then(function (itemsA) { return _this.itemsA = itemsA; }, function (error) { return _this.errorMessage = error; });
    };
    AppComponent.prototype.getItemsB = function () {
        var _this = this;
        this.matchService.getItemsB()
            .then(function (itemsB) { return _this.itemsB = itemsB; }, function (error) { return _this.errorMessage = error; });
    };
    ...
    AppComponent.prototype.getCategories = function () {
        ...
        this.matchService.getCategories()
            ...
            $("#discipline").autocomplete({
                source: _this.categories
            });
        }, function (error) { return _this.errorMessage = error; });
    };
    AppComponent.prototype.DoneEditApplicant = function (who) {
        if (who == 'A') {
    ...
    AppComponent.prototype.SetCategory = function (event) {
        this.importItem.category = event.srcElement.innerText;
        //console.log(event.srcElement.innerText); 
        // console.log(event);
    };
    AppComponent.prototype.SetLocation = function (event) {
        this.importItem.location = event.srcElement.innerText;
        //console.log(event.srcElement.innerText); 
        // console.log(event);
    };
    AppComponent.prototype.checkInput = function (location, discipline) {
    ...
    AppComponent.prototype.AddItem = function (who) {
    ...
    AppComponent.prototype.AutoReMatch = function (who) {
        this.optionWhoLeading = who;
        this.makeAutoItems2();
    };
    AppComponent.prototype.makeAutoItems2 = function () {
        this.autoItems = [];
    ...
    AppComponent.prototype.makeManualItems2 = function () {
    ...
    AppComponent.prototype.CompareTwo = function (itemA, itemB) {
    ...
    AppComponent.prototype.GetDistances = function (locA, locB) {
        ...
        var range = indexlocA - indexlocB;
        var maxIndex = range > 0 ? indexlocA : indexlocB;
        if (range < 0)
            range = -range;
        //console.log("indexlocA: " + indexlocA + " indexlocB: " + indexlocB + " range: " + range);
        var pos = locations[maxIndex - 1].d.length - range - 1;
        d = locations[maxIndex - 1].d[pos];
        console.log("d: " + d + " indexlocA: " + indexlocA + " indexlocB: " + indexlocB + " range: " + range);
        return d;
    };
    AppComponent.prototype.onDelete = function (item, who) {
        console.log(item);
        if (who == 'A')
    ...
    AppComponent.prototype.onDeleteManualItem = function (item) {
        console.log(item);
    ...
    AppComponent.prototype.onItemDown = function (item, itemList) {
        console.log(item);
        ...
        if (index >= (length - 1))
            return;
        var next = itemList[index + 1];
        itemList[index + 1] = item;
        itemList[index] = next;
        this.selectedItem = itemList[index + 1];
    };
    AppComponent.prototype.onItemUp = function (item, itemList) {
        console.log(item);
        var index = itemList.indexOf(item);
        console.log(index);
    ...
    AppComponent.prototype.OnExportAsPDF = function () {
        ...
        for (var i = 0; i < this.manualItems.length; i++) {
            var row = [];
            var order = { 'rowSpan': 2, 'text': '' };
            order.rowSpan = 2;
            order.text = i + 1 + '';
            ...
            if (this.optionWhoLeading == "A") {
                row.push(order);
                row.push(this.nameA);
                var combined = this.manualItems[i].A.location + " : " + this.manualItems[i].A.category + ". ";
                ...
                row.push(order);
                row.push(this.nameB);
                var combined = this.manualItems[i].B.location + " : " + this.manualItems[i].B.category + ". ";
                if (this.manualItems[i].B.note.length > 0)
                    combined += "[note: " + this.manualItems[i].B.note + "]";
                row.push(combined);
        ...
        var filename = "match_" + this.nameA1 + "_" + this.nameB1 + ".pdf";
        if (this.optionWhoLeading == "A") {
            ...
            var filename_1 = "match_" + this.nameB1 + "_" + this.nameA1 + ".pdf";
        }
    ...
    AppComponent.prototype.displayManualRankItem = function (item, who) {
        return displayAutoRankItem(item, who);
    };
    AppComponent.prototype.displayAutoRankItem = function (item, who) {
    ...
    AppComponent.prototype.displayMe = function (item, full) {
        var display = item.location + " : " + item.category + ".";
    ...
    AppComponent = __decorate([
        core_1.Component({
            ...
            providers: [ng2_dnd_1.DND_PROVIDERS, match_service_promise_1.MatchService]
        }), 
        __metadata('design:paramtypes', [match_service_promise_1.MatchService])
    ], AppComponent);
    return AppComponent;
}());
